  ...
  return (
    <header
      className={classNames(
        'fixed top-0 left-0 w-full h-[56px] flex item-center z-10 hover:bg-white transition-all duration-[.3s] ease-in-out group',
        'md:h-[88px]'
      )}
    >
      {/* Header Inner */}
      ...
      >
        ...
        <div className="flex item-center gap-[30px]">
          ...
          <div>
            <button className="flex item-start">
              <ShoppingBagIcon className="h-5 w-5" />
              <span className="w-3 h-3 border bg-transparent flex items-center justify-center text-[8px] leading-3 relative top-[-2px] group-hover:text-black group-hover:border-black rounded-full">
                0
              </span>
            </button>
